...
type FileServiceClient interface {
	Info(ctx context.Context, in *FileInfoRequest, opts ...grpc.CallOption) (*FileInfo, error)
...
func (c *fileServiceClient) Info(ctx context.Context, in *FileInfoRequest, opts ...grpc.CallOption) (*FileInfo, error) {
	out := new(FileInfo)
	err := c.cc.Invoke(ctx, "/pb.FileService/Info", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *fileServiceClient) Download(ctx context.Context, in *DownloadFileRequest, opts ...grpc.CallOption) (FileService_DownloadClient, error) {
	stream, err := c.cc.NewStream(ctx, &FileService_ServiceDesc.Streams[0], "/pb.FileService/Download", opts...)
	if err != nil {
		return nil, err
	}
...
type FileServiceServer interface {
	Info(context.Context, *FileInfoRequest) (*FileInfo, error)
...
func (UnimplementedFileServiceServer) Info(context.Context, *FileInfoRequest) (*FileInfo, error) {
...
func _FileService_Info_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.FileService/Info",
	}
